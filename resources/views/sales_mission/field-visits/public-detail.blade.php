...
<body>
    <div class="container">
        ...
        <a href="{{ route('public.field-visits.index') }}" class="back-link">
        ...
        <div class="actions-footer">
            <a href="{{ route('public.field-visits.index') }}" class="btn btn-outline">
                <i class="fas fa-arrow-left"></i>
                Back to List
            </a>
            @if(isset($fieldVisit->feedbackSurvey))
                <a href="{{ route('sales_mission.surveys.public.form', $fieldVisit->feedbackSurvey->survey_token) }}" target="_blank" class="btn btn-primary">
                    <i class="fas fa-clipboard-list"></i>
                    View Feedback Survey
                </a>
            @endif
        </div>
    </div>
