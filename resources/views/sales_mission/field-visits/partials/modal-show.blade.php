...
<div class="bg-gray-50 rounded-lg overflow-hidden mt-6 shadow-sm">
    ...
    <div class="p-6">
        <div class="flex items-center justify-between">
            ...
            @if(!$fieldVisit->feedbackSurvey->is_completed)
            <a href="{{ $fieldVisit->feedbackSurvey->public_url }}" target="_blank" class="px-3 py-1.5 text-xs font-medium bg-amber-50 text-amber-700 rounded-md hover:bg-amber-100 transition-colors inline-flex items-center">
                <svg class="w-3.5 h-3.5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
