            ...
            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-border px-10 py-3">
                ...
                <div class="flex flex-1 justify-end gap-8">
                    <div class="flex items-center gap-9">
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('superadmin.dashboard') ? 'font-bold' : '' }}" href="{{ route('superadmin.dashboard') }}">Dashboard</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('superadmin.meeting_rooms*') ? 'font-bold' : '' }}" href="{{ route('superadmin.meeting_rooms') }}">Ruang Meeting</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('superadmin.departments*') ? 'font-bold' : '' }}" href="{{ route('superadmin.departments') }}">Departemen</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('superadmin.employees*') ? 'font-bold' : '' }}" href="{{ route('superadmin.employees') }}">Karyawan</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('superadmin.reports*') || Request::routeIs('superadmin.activity.*') ? 'font-bold' : '' }}" href="{{ route('superadmin.reports') }}">Reports</a>
                    </div>
                    ...
                    <div class="flex h-full min-h-[700px] flex-col justify-between bg-white p-4">
                        <div class="flex flex-col gap-4">
                            <div class="flex flex-col gap-2">
                                <a href="{{ route('superadmin.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.dashboard') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                ...
                                <a href="{{ route('superadmin.users') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.users') || Request::routeIs('superadmin.users.*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                    ...
                                    <p class="text-dark text-sm font-medium leading-normal">Manajemen User</p>
                                </a>
                                <a href="{{ route('superadmin.bookings.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.bookings*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('superadmin.activities.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.activities*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                    ...
                                    <p class="text-dark text-sm font-medium leading-normal">Aktivitas</p>
                                </a>
                                <a href="{{ route('superadmin.meeting_rooms') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.meeting_rooms*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('superadmin.departments') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.departments*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('superadmin.employees') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.employees*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('superadmin.logs.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.logs*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                    ...
                                    <p class="text-dark text-sm font-medium leading-normal">Activity Logs</p>
                                </a>
                                <a href="{{ route('superadmin.reports') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('superadmin.reports*') || Request::routeIs('superadmin.activity.*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
