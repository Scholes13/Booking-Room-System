...
<body class="bg-gray-50 text-dark">
        ...
        <div id="sidebar-content" class="py-4">
            <nav class="px-4">
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('superadmin.users.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('superadmin.users.*') ? 'active' : '' }}">
                            <div class="text-inherit sidebar-icon-container">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                            ...
                            <span class="text-sm font-medium sidebar-text">Manajemen User</span>
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('superadmin.logs.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('superadmin.logs*') ? 'active' : '' }}">
                            ...
                            <span class="text-sm font-medium sidebar-text">Activity Logs</span>
                        </a>
                    </li>
                    <li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const sidebarCollapsed = localStorage.getItem('superadmin_sidebar_collapsed') === 'true';
            ...
            toggleBtn.addEventListener('click', function() {
                ...
                localStorage.setItem('superadmin_sidebar_collapsed', sidebar.classList.contains('collapsed'));
            });
