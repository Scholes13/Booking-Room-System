...
<div class="flex flex-col gap-6 h-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <!-- Total Booking Card -->
        <div class="bg-white rounded-lg p-4 flex items-center gap-4 border-l-4 border-green-500 shadow-sm">
        ...
        <div class="bg-white rounded-lg p-4 flex items-center gap-4 border-l-4 border-purple-500 shadow-sm">
            <div class="flex justify-center items-center rounded-full bg-purple-500 bg-opacity-10 p-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" class="text-purple-500" viewBox="0 0 256 256">
    ...
    <div class="bg-white rounded-lg p-6 shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="{{ route('superadmin.users') }}" class="flex items-center p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
            ...
            <a href="{{ route('superadmin.meeting_rooms') }}" class="flex items-center p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition">
            ...
            <a href="{{ route('superadmin.activities.index') }}" class="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
