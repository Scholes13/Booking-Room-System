...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('DOM fully loaded and parsed - Superadmin bookings page');
        ...
        try {
            ...
            // Direct attachment of click handlers for better compatibility
            ...
            editButtons.forEach(function(button) {
                button.onclick = function(e) {
                    ...
                    const bookingType = this.getAttribute('data-booking-type') || 'internal';
                    const externalDescription = this.getAttribute('data-external-description') || '';
                    
                    console.log('Editing booking ID:', currentBookingId);
                    
                    // Set form action
                    editBookingForm.action = "{{ route('superadmin.bookings.update', '') }}/" + currentBookingId;
            ...
            // Add click handlers to each delete button
