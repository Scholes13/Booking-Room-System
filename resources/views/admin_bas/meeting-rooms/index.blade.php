...
<div class="flex flex-col gap-6 h-full">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('bas.meeting_rooms.create') }}" class="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-primary text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em]">
                    ...
                    <tr class="border-b border-border room-row">
                        ...
                        <td class="px-4 py-4 text-right">
                            <div class="flex flex-col items-end space-y-1">
                                <a href="{{ route('bas.meeting_rooms.edit', $room->id) }}" class="text-accent font-medium text-sm hover:underline">Edit</a>
