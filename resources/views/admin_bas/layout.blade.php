            ...
            theme: {
                extend: {
                    colors: {
                        ...
                        danger: '#C12929',
                        border: '#E9DFCE',
                        bas: '#8e2742', // Special color for Admin BAS
                    }
                }
            }
        }
        ...
        <div class="layout-container flex h-full grow flex-col">
            ...
            <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-border px-10 py-3">
                <div class="flex items-center gap-4 text-dark">
                    ...
                    <h2 class="text-dark text-lg font-bold leading-tight tracking-[-0.015em]">Meeting Room Booking <span class="text-bas">(Admin BAS)</span></h2>
                </div>
                <div class="flex flex-1 justify-end gap-8">
                    <div class="flex items-center gap-9">
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('bas.dashboard') ? 'font-bold' : '' }}" href="{{ route('bas.dashboard') }}">Dashboard</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('bas.activities*') ? 'font-bold' : '' }}" href="{{ route('bas.activities.index') }}">Aktivitas</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('bas.meeting_rooms') ? 'font-bold' : '' }}" href="{{ route('bas.meeting_rooms') }}">Ruang Meeting</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('bas.departments') ? 'font-bold' : '' }}" href="{{ route('bas.departments') }}">Departemen</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('bas.employees') ? 'font-bold' : '' }}" href="{{ route('bas.employees') }}">Karyawan</a>
                        <a class="text-dark text-sm font-medium leading-normal {{ Request::routeIs('bas.reports') || Request::routeIs('bas.activity.*') ? 'font-bold' : '' }}" href="{{ route('bas.reports') }}">Reports</a>
                    </div>
                    ...
                    <div class="flex h-full min-h-[700px] flex-col justify-between bg-white p-4">
                        <div class="flex flex-col gap-4">
                            <div class="flex flex-col gap-2">
                                <a href="{{ route('bas.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.dashboard') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                ...
                                <!-- Activity Management - Highlight with BAS color - MOVED UP TO POSITION #2 -->
                                <a href="{{ route('bas.activities.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.activities*') ? 'bg-secondary' : '' }}">
                                    <div class="text-bas">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                    ...
                                    <p class="text-bas font-medium text-sm leading-normal">Aktivitas</p>
                                </a>
                                <a href="{{ route('bas.bookings.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.bookings.index') || Request::routeIs('bas.bookings.edit') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('bas.meeting_rooms') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.meeting_rooms') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('bas.departments') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.departments') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('bas.employees') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.employees') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                                ...
                                <a href="{{ route('bas.reports') }}" class="flex items-center gap-3 px-3 py-2 rounded-full {{ Request::routeIs('bas.reports') || Request::routeIs('bas.activity.*') ? 'bg-secondary' : '' }}">
                                    <div class="text-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
