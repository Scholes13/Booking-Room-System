...
<body class="bg-gray-50 text-dark">
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="{{ route('bas.activities.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('bas.activities.*') ? 'active' : '' }}">
                            ...
                            <span class="ml-auto px-2 py-0.5 text-xs rounded-full bg-bas/10 text-bas sidebar-text">New</span>
                        </a>
                    </li>
                    <li>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const sidebarCollapsed = localStorage.getItem('admin_bas_sidebar_collapsed') === 'true';
