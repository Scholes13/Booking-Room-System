...
<div class="flex flex-col gap-6 h-full">
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
        ...
        <a href="{{ route('bas.employees.create') }}" class="flex cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-5 bg-[#24448c] text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#1c3670] transition-colors shadow-sm w-full sm:w-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                <div class="relative">
                    ...
                    <input type="search" id="searchInput" name="search" value="{{ request('search') }}" class="block w-full p-2.5 sm:p-3 ps-10 text-sm text-dark border border-gray-200 rounded-lg bg-gray-50 focus:ring-[#24448c] focus:border-[#24448c] transition-all shadow-sm" placeholder="Search name, position, phone, or email...">
                </div>
            </div>
            
            <!-- Department Filter -->
            <div>
                <select id="departmentFilter" name="department_id" class="block w-full p-2.5 sm:p-3 text-sm text-dark border border-gray-200 rounded-lg bg-gray-50 focus:ring-[#24448c] focus:border-[#24448c] transition-all shadow-sm appearance-none bg-no-repeat bg-[right_0.5rem_center] bg-[length:1em]" style="background-image: url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 fill=%27none%27 viewBox=%270 0 20 20%27%3e%3cpath stroke=%27%236B7280%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27 stroke-width=%271.5%27 d=%27M6 8l4 4 4-4%27/%3e%3c/svg%3e')">
            ...
            <!-- Gender Filter -->
            <div>
                <select id="genderFilter" name="gender" class="block w-full p-2.5 sm:p-3 text-sm text-dark border border-gray-200 rounded-lg bg-gray-50 focus:ring-[#24448c] focus:border-[#24448c] transition-all shadow-sm appearance-none bg-no-repeat bg-[right_0.5rem_center] bg-[length:1em]" style="background-image: url('data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 fill=%27none%27 viewBox=%270 0 20 20%27%3e%3cpath stroke=%27%236B7280%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27 stroke-width=%271.5%27 d=%27M6 8l4 4 4-4%27/%3e%3c/svg%3e')">
...
<div id="confirmDeleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 transition-opacity duration-300">
    <div class="bg-white p-6 rounded-xl shadow-xl max-w-md w-full mx-4 transform transition-transform duration-300 scale-100">
        ...
        <div class="flex justify-center gap-3">
            ...
            <form id="deleteForm" method="POST" action="{{ route('bas.employees.delete', '') }}" class="flex-1">
                @csrf
                @method('DELETE')
