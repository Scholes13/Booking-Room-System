...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <form action="{{ route('bas.employees.store') }}" method="POST" class="space-y-4">
            @csrf
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Add keyboard navigation to department dropdown
        const departmentSelect = document.getElementById('department-select');
        
        if (departmentSelect) {
            departmentSelect.addEventListener('keydown', function(event) {
                // Only process if a single letter key is pressed (not arrows, etc)
