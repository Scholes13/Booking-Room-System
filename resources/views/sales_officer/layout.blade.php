...
<head>
    ...
    <title>Sales Officer - @yield('title')</title>
    ...
    <div id="sidebar" class="w-64 bg-white shadow-md">
        ...
        <div id="sidebar-content" class="py-4">
            <nav class="px-4">
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('sales_officer.dashboard') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('sales_officer.dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('sales_officer.activities.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('sales_officer.activities.*') ? 'active' : '' }}">
                            <div class="text-inherit sidebar-icon-container">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <li>
                        <a href="{{ route('sales_officer.contacts.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('sales_officer.contacts.*') ? 'active' : '' }}">
                            <div class="text-inherit sidebar-icon-container">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <li>
                        <a href="{{ route('sales_officer.calendar') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('sales_officer.calendar') ? 'active' : '' }}">
                            <div class="text-inherit sidebar-icon-container">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                    ...
                    <li>
                        <a href="{{ route('sales_officer.reports.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2.5 rounded-lg {{ Request::routeIs('sales_officer.reports.*') ? 'active' : '' }}">
                            <div class="text-inherit sidebar-icon-container">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <div class="space-y-3">
                    <div class="bg-gray-50 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs text-primary font-semibold">{{ now()->format('M Y') }}</span>
                        </div>
                        <div class="mt-1">
        ...
        <div class="bg-white shadow-sm mb-6">
            <div class="flex items-center justify-between px-6 py-3">
                <div>
                    ...
                    <p class="text-sm text-gray-600">@yield('description', 'Overview and statistics')</p>
                </div>
