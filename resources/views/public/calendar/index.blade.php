    ...
    <div class="bg-gray-800 p-6 rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        <div class="space-y-4">
            ...
            <div class="text-gray-300">
                ...
                <p id="modalType" class="ml-2"></p>
            </div>
            <div class="text-gray-300">
                <p class="font-semibold">Description:</p>
                <p id="modalDescription" class="ml-2"></p>
            </div>
            <div id="modalExternalDescContainer" class="text-gray-300 hidden">
                <p class="font-semibold">External Description:</p>
                <p id="modalExternalDesc" class="ml-2"></p>
            </div>
            <div class="text-gray-300">
...
document.addEventListener('DOMContentLoaded', function() {
                    ...
                    finalEvents.push({
                        ...
                        extendedProps: {
                            ...
                            hiddenEvents: hiddenEvents.map(evt => ({
                                ...
                                booking_type: evt.extendedProps?.booking_type,
                                external_description: evt.extendedProps?.external_description
                            }))
                        }
                    });
    ...
    function showEventModal(evt) {
        ...
        document.getElementById('modalRoom').textContent = evt.extendedProps?.room_name || 'Meeting Room';
        document.getElementById('modalType').textContent = evt.extendedProps?.booking_type ? 
            (evt.extendedProps.booking_type.charAt(0).toUpperCase() + evt.extendedProps.booking_type.slice(1)) : 'Internal';
        document.getElementById('modalDescription').textContent = evt.extendedProps?.description || '';
        document.getElementById('modalCreatedBy').textContent = evt.extendedProps?.created_by || '';

        // Handle external description
        const externalDescContainer = document.getElementById('modalExternalDescContainer');
        const externalDesc = document.getElementById('modalExternalDesc');
        if (evt.extendedProps?.booking_type === 'external' && evt.extendedProps?.external_description) {
            externalDescContainer.classList.remove('hidden');
            externalDesc.textContent = evt.extendedProps.external_description;
        } else {
            externalDescContainer.classList.add('hidden');
            externalDesc.textContent = '';
        }
    ...
    function showMoreModal(hiddenEvents) {
        ...
        hiddenEvents.forEach(ev => {
            ...
            let bookingType = ev.booking_type || 'Internal';
            card.innerHTML = `
                ...
                <div class="text-xs mb-1">${bookingType.charAt(0).toUpperCase() + bookingType.slice(1)}</div>
            ...
            card.addEventListener('click', () => {
                ...
                showEventModal({
                    ...
                    extendedProps: {
                        ...
                        booking_type: ev.booking_type,
                        external_description: ev.external_description
                    }
                });
            });
    ...
    const calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            if (props.isMore) {
                ...
                showEventModal({
                    ...
                    extendedProps: {
                        ...
                        external_description: props.external_description
                    }
                });
            }
        },
        ...
        eventContent: function(arg) {
            ...
            let bookingType = arg.event.extendedProps.booking_type || 'Internal';
            ...
            return {
                html: `
                    <div class="fc-event-content">
                        ...
                        <div class="fc-event-type">${bookingType.charAt(0).toUpperCase() + bookingType.slice(1)}</div>
