    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="bg-white rounded-lg p-4 shadow-sm">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div class="space-y-2">
                    <label for="searchInput" class="block text-sm font-medium text-dark">Cari Nama/Jabatan</label>
                    <div class="relative">
                        ...
                        <input type="search" id="searchInput" name="search" value="{{ request('search') }}" class="block w-full p-3 ps-10 text-sm text-dark border border-border rounded-md bg-gray-50 focus:ring-primary focus:border-primary" placeholder="Cari karyawan...">
                    </div>
                </div>
