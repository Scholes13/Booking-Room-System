            ...
            <tr class="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td class="px-5 py-4 text-right">
                    <div class="flex items-center justify-end space-x-2">
                        @php
                        $routePrefix = request()->route()->getPrefix() == '/superadmin/employees' ? 'superadmin' : 'admin';
                        @endphp
                        <a href="{{ route($routePrefix.'.employees.edit', $employee->id) }}" class="px-3 py-1.5 text-xs font-medium bg-blue-50 text-blue-700 rounded-md hover:bg-blue-100 transition-colors inline-flex items-center">
            ...
            <tr>
                <td colspan="8" class="px-5 py-10 text-center">
                    <div class="flex flex-col items-center justify-center">
                        ...
                        <p class="text-gray-500 text-sm">Coba ubah kriteria pencarian atau tambahkan karyawan baru</p>
                    </div>
                </td>
            </tr>
            @endforelse
        ...
        <div class="p-4 bg-white hover:bg-gray-50">
            <div class="flex flex-col gap-3">
                ...
                <div class="grid grid-cols-2 gap-x-2 gap-y-1 text-sm">
                    ...
                    <!-- Contact Information -->
                    @if($employee->phone)
                    <div class="text-gray-500">HP/WA:</div>
...
<div class="flex flex-col md:flex-row justify-between items-center gap-4">
    <div class="text-sm text-gray-600 flex items-center bg-gray-50 px-3 py-2 rounded-lg w-full md:w-auto">
        ...
        <div class="truncate">
            ...
            <span class="hidden sm:inline">sampai</span><span class="sm:hidden">-</span>
    ...
    <div class="flex items-center gap-1 flex-wrap justify-center">
        ...
        @for ($i = $startPage; $i <= $endPage; $i++)
            @if ($i == $employees->currentPage())
                <span class="w-7 h-7 sm:w-8 sm:h-8 md:w-9 md:h-9 flex items-center justify-center border border-primary bg-primary text-white rounded-lg">{{ $i }}</span>
            @else
