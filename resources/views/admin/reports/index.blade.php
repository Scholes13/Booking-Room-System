...
<div class="space-y-6">
    ...
    <div class="flex border-b border-gray-200 mb-6">
        <a href="{{ route('admin.reports') }}" class="py-3 px-6 font-medium text-sm rounded-t-lg bg-primary text-white">
            Booking Reports
        </a>
        <a href="{{ route('admin.activity.index') }}" class="py-3 px-6 font-medium text-sm text-gray-600 hover:text-primary">
            Activity Reports
        </a>
    </div>
