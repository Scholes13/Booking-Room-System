...
<div class="flex flex-col gap-6 h-full">
    ...
    <div class="flex items-center justify-between">
        ...
        <button id="btnTambahDepartemen" class="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-primary text-white gap-2 text-sm font-bold leading-normal tracking-[0.015em]">
    ...
    <div class="flex gap-6">
        ...
        <div class="bg-white rounded-lg p-6 flex items-center gap-4 min-w-64 border-l-4 border-primary shadow-sm">
                    ...
                    <tr class="border-b border-border department-row">
                        ...
                        <td class="px-4 py-4 text-right">
                            <div class="flex flex-col items-end space-y-1">
                                <a href="{{ route('admin.departments.edit', $department->id) }}" class="text-accent font-medium text-sm hover:underline">Edit</a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        deleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                deleteForm.action = `{{ route('admin.departments.delete', '') }}/${departmentId}`;
