    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
            ...
            <select id="report_type" class="w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-primary/20">
                <option value="employee_activity">{{ __('Employee Activity Reports') }}</option>
                <option value="department_activity">{{ __('Department Activity Reports') }}</option>
                <option value="location_activity">{{ __('Location Activity Reports') }}</option>
                <option value="detailed_activity">{{ __('Detailed Activity Reports') }}</option>
            </select>
        </div>
